...
print(" get features")
print("current_time:", datetime.now()-start_time)
...
print("Read in and do some basic processing")
print("current_time:", datetime.now()-start_time)
...
print("Find and drop static columns")
print("current_time:", datetime.now()-start_time)
...
print("test")
test_preds.select("prediction").write.csv("/Users/azalea/Desktop/pythonProject/predictions.csv", mode="overwrite")
print("current_time:", datetime.now()-start_time)
